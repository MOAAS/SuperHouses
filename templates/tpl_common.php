              ...
              <ul>
                ...
                <li>
                  ...
                  <div id="dropdownbackground" class="dropdown-content">
                    ...
                    <a id="menuyourplacesbutton" href="profile.php#Your%20places">Your places</a>
                    <a id="menuaddplacebutton" href="profile.php#Add%20place">Add place</a>
                    <a id="menufutureguestsbutton" href="profile.php#Future%20guests">Future guests</a>
                    <a id="menuyourreservationsbutton" href="profile.php#Your%20reservations">Your Reservations</a>
